<head>
    ...
    <link rel="icon" href="<?php echo "http://".$_SERVER["SERVER_NAME"]."/yehoshua/" ?>resources/img/logo.ico" />

    <link rel="stylesheet" href="<?php echo "http://".$_SERVER["SERVER_NAME"]."/yehoshua/" ?>resources/icomoon/style.css">
